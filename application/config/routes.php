...
$route['admin/news/news_details/(:any)-(:num).html'] = 'admin/news/news_details/$1/$2';
$route['admin/news2/news2_details/(:any)-(:num).html'] = 'admin/news2/news2_details/$1/$2';
$route['admin/general_customers/general_customers_details1/(:any)-(:num).html'] = 'admin/general_customers/general_customers_details1/$1/$2';
$route['admin/general_customers/general_customers_details2/(:any)-(:num).html'] = 'admin/general_customers/general_customers_details2/$1/$2';
//$route['admin/news/news_list'] = 'admin/news/news_list';
