        ...
        <div class=" bottom-header">
            ...
            <a href="<?php echo base_url() ?>">
                <div class="item-header" style="width: 170px">
                    <div class="icon-item-header"><a href="#" class="playGame"><img src="<?php echo public_url('images/logo_login.png') ?>"
            ...
            <!-- <div class="item-header" style="width: 80px; float: left;">
				<a href="<?php echo base_url() ?>"><img src="<?php echo public_url('images/logo_login.png') ?>" width="55px"></a>
			</div> -->
