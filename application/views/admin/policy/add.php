...
<div class="page-title">
    ...
    <!--            <a href="--><?php //echo admin_url('policy') ?><!--" class="btn btn-info btn-sm">Danh sách</a>-->
    <!--        </div>-->
    <!--    </div>-->
</div>
<div class="x_panel">
...
<!--            </div>-->
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12">Thuộc KTV/KH</label>
                <div class="col-md-8 col-sm-8 col-xs-12">
...
<!--                            class="required">*</span></label>-->
<!--                <div class="col-md-8 col-sm-8 col-xs-12">-->
<!--                    <input type="file" class="form-control" name="img_policy" id="img_policy">-->
<!--                </div>-->
<!--            </div>-->
            ...
            <div class="form-group" style="margin-top: 30px">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-1" style="width: 70px">
                    <a href="<?php echo admin_url('policy') ?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
