...
<div class="page-title">
    <div class="title_left"><h3>Bảng tin nội bộ(<?php echo count($news2) ?>)</h3></div>
...
<div class="x_panel">
    <div class="x_title">
<!--        <h2>Danh sách bài đăng(--><?php //echo count($news2) ?><!--)</h2>-->
        <div class="col-md-6 col-sm-6 col-xs-12 pull-left">
            <a href="<?php echo admin_url('news2/add') ?>" class="btn btn-primary btn-sm">Thêm mới</a>
            <!--            <a href="-->
            <?php //echo admin_url('admin') ?><!--" class="btn btn-info btn-sm">Quay lại danh sách</a>-->
        </div>
...
<!--                    <td><img src="--><?php //echo base_url('public/images/news/'.$row->img)?><!--" style="max-width: 80px"> </td>-->
                    ...
                    <td>
                        <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/news2/edit/'.$row->id)?>"><i class="fa fa-pencil"></i> Sửa</a>
...
//            console.log('delll');
            window.location.href = '<?php echo base_url('admin/news2/del/')?>' + id;
        }
    }
</script>