...
<div class="x_panel">
    ...
    <script src="<?php echo base_url(); ?>public/js_highcharts/highcharts.js"></script>
    <!--    <script src="--><?php //echo base_url(); ?><!--public/js_highcharts/series-label.js"></script>-->
    <!--    <script src="--><?php //echo base_url(); ?><!--public/js_highcharts/exporting.js"></script>-->
    <!--    <script src="--><?php //echo base_url(); ?><!--public/js_highcharts/export-data.js"></script>-->
...
//                            echo $key2 . '-' . $value2 . '<br/>';
//                            echo $value2[0] . '<br/>';
//                            echo $key2 . '-' . $value2[1] . '<br/>';
//                            echo $value2[2] . '<br/>';
//                            echo  $value2 . '<br/>';
                            if (isset($value2[0]) && $value2[0] != '') {

                                if ($value2[0] == 1) {
                                    $android = explode(':', $value2)[1];
                                }

                                if ($value2[0] == 2) {
                                    $ios = explode(':', $value2)[1];
                                }

                                if ($value2[0] == 3) {
                                    $ccu_web = explode(':', $value2)[1];
                                }
                            }
                        }
                        ?>
