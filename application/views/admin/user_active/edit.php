...
<div class="x_panel">
    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <label class="control-label col-md-2 col-sm-2 col-xs-12 text-nowrap" for="first-name">Tỉnh / TP hoạt động<span
                        class="required"></span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <select class="select2_group form-control" name="city_work_id" id="mySelect" onchange="myFunction()">
                    <?php
                    foreach ($vn_city as $value) { ?>
                        <option value="<?php echo $value->id ?>" <?php if ($value->id == $user->city_work_id) echo 'selected' ?>>
            ...
            <label class="control-label col-md-2 col-sm-2 col-xs-12 text-nowrap" for="first-name">Quận / Huyện hoạt động<span
                        class="required"></span></label>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <select class="select2_group form-control" name="vn_district" id="vn_district_new">
                    <?php
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <a href="<?php echo admin_url('user_active') ?>" class="btn btn-success">Quay lại</a>
            </div>
        </div>
    </form>
</div>
