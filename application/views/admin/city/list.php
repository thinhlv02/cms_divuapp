...
<div class="page-title">
    <div class="title_left"><h3>Danh sách thành phố(<?php echo count($res) ?>)</h3></div>
...
<!--                    <td><img src="--><?php //echo base_url('public/images/news/'.$row->img)?><!--" style="max-width: 80px"> </td>-->
                    <td>
                        <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/city/edit/'.$row->id)?>"><i class="fa fa-pencil"></i> Sửa</a>
