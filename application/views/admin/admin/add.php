...
<div class="x_panel">
    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="first-name">Tên đăng nhập<span
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <a href="<?php echo admin_url('admin') ?>" class="btn btn-success">Quay lại danh sách</a>
            </div>
        </div>
    </form>
</div>
