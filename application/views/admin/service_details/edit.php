    ...
    <div class="x_content">
        ...
        <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Tên Gói<span
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-1 text-nowrap" for="first-name">Gói chi tiết<span
                            class="required"></span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="select2_group form-control" name="service_package_id">
                        <?php
                        foreach ($service_package as $value) { ?>
                            <option value="<?php echo $value->id ?>" <?php if ($value->id == $res->service_package_id) echo 'selected' ?>><?php echo $value->name ?></option>
                        <?php } ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <textarea name="txtContent" class="form-control"
                              style="height: 120px"><?php echo $res->des ?></textarea>
...
<!--                        <td>--><?php //echo $res->img ?><!--</td>-->
                    ...
                    <?php } ?>
                    <input type="file" class="form-control" name="img_service_details" id="img_service_details">
                </div>
            </div>
            ...
            <div class="form-group" style="margin-top: 30px">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-1" style="width: 70px">
                    <a href="<?php echo admin_url('service_details') ?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
        </form>
    </div>
