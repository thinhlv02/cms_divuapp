...
<div class="page-title">
    ...
    <div class="title_right">
        <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
            <!--            <a href="-->
            <?php //echo admin_url('admin_mission/add') ?><!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
            <a href="<?php echo admin_url('admin_mission') ?>"
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <select class="select2_group form-control" name="emp">
                    ...
                    <?php foreach ($list_emp as $value): ?>
                        <option value="<?php echo $value->id ?> "<?php if ($admin_id == $value->id) echo 'selected' ?>>
            ...
            <div class="col-md-7 col-sm-7 col-xs-12">
                <textarea disabled class="form-control" rows="3" placeholder=""
                          name="des"><?php echo $info->des ?></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2" style="width: 70px">
                <input type="submit" id="btnAddEvent" name="btnAddadmin_mission" required
