...
<div class="page-title">
    ...
    <!--            <!--            <a href="-->
    <!--            --><?php ////echo admin_url('intro_service/add')?><!--<!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
    <!--            <a href="--><?php //echo admin_url('intro_service') ?><!--" class="btn btn-info btn-sm">Danh sách</a>-->
    <!--        </div>-->
    <!--    </div>-->
</div>
<div class="x_panel">
...
<!--                            class="required">*</span></label>-->
<!--                <div class="col-md-8 col-sm-8 col-xs-12">-->
<!--                    <input type="file" class="form-control" name="img_intro_service" id="img_intro_service">-->
<!--                </div>-->
<!--            </div>-->
            ...
            <div class="form-group" style="margin-top: 30px">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-1" style="width: 70px">
                    <a href="<?php echo admin_url('intro_service') ?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
