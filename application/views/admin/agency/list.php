...
<div class="page-title">
    <div class="title_left"><h3>Đại lý(<?php echo count($res) ?>)</h3></div>
...
<div class="x_panel">
    <div class="x_title">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 pull-left">
            <a href="<?php echo admin_url('agency/add') ?>" class="btn btn-primary btn-sm">Thêm mới</a>
            <!--            <a href="-->
            <?php //echo admin_url('admin') ?><!--" class="btn btn-info btn-sm">Quay lại danh sách</a>-->
        </div>
        ...
        <table id="datatable-product" class="table table-striped table-bordered bulk_action">
            ...
            <?php foreach ($res as $row) {
                ...
                <tr>
                    ...
                    <td><p class="label label-primary"><?php echo $row->name_area ?></p></td>
                    ...
                    <td>
                        <a class="btn btn-info btn-xs"
                           href="<?php echo base_url('admin/agency/edit/' . $row->id) ?>"><i class="fa fa-pencil"></i> Sửa</a>
