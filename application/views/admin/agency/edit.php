    ...
    <form id="" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <textarea name="agency_name" class="form-control" rows="1"
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <!--                <input type="text" name="agency_name" value='--><?php //echo (string)$agency->agency_name ?><!--'-->
                <!--                       placeholder="Tên tài sản/ Model tài sản" class="form-control col-md-7 col-xs-12">-->
                <textarea name="phone" class="form-control" rows="1"
                          placeholder="SĐT "><?php echo $res->phone ?></textarea>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <a href="<?php echo admin_url('agency') ?>" class="btn btn-success">Quay lại</a>
            </div>
        </div>
    </form>
</div>
