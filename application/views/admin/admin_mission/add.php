...
<!--            <a href="--><?php //echo admin_url('admin_mission/add') ?><!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
            <a href="<?php
            $id = $this->uri->segment(4);
            $date1 = $this->uri->segment(7);
            $date2 = $this->uri->segment(8);
            if ($date1 != '' && $date2 != '') {
            echo admin_url('admin_mission?date1=' . $date1 . '&date2=' . $date2 . '&asset_id=' . $id . '#' . $id) ;
            } else
            echo admin_url('admin_mission') ?>"
