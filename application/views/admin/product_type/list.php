...
<div class="page-title">
    <div class="title_left"><h3>Danh sách(<?php echo count($res) ?>)</h3></div>
...
<div class="x_panel">
    <div class="x_title">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 pull-left">
            <a href="<?php echo admin_url('product_type/add') ?>" class="btn btn-primary btn-sm">Thêm mới</a>
            <!--            <a href="-->
            <?php //echo admin_url('admin') ?><!--" class="btn btn-info btn-sm">Quay lại danh sách</a>-->
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-xs"
                           href="<?php echo base_url('admin/product_type/edit/' . $row->id) ?>"><i class="fa fa-pencil"></i> Sửa</a>
...
//            console.log('delll');
            window.location.href = '<?php echo base_url('admin/product_type/del/')?>' + id;
        }
    }
</script>