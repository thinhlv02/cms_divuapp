...
<div class="page-title">
    ...
    <!--            <!--            <a href="-->
    <!--            --><?php ////echo admin_url('info_service/add')?><!--<!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
    <!--            <a href="--><?php //echo admin_url('info_service') ?><!--" class="btn btn-info btn-sm">Danh sách</a>-->
    <!--        </div>-->
    <!--    </div>-->
</div>
<div class="x_panel">
...
<!--            </div>-->
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12 white-space" for="first-name">Gói DV<span
                            class="required">*</span></label>
                <div class="col-md-8 col-sm-8 col-xs-12">
...
<!--                            class="required">*</span></label>-->
<!--                <div class="col-md-8 col-sm-8 col-xs-12">-->
<!--                    <input type="file" class="form-control" name="img_info_service" id="img_info_service">-->
<!--                </div>-->
<!--            </div>-->
