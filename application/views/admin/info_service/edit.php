...
<!--                    <input type="text" id="txtName" name="txtName" value="--><?php //echo $info_service->title ?><!--"-->
...
<!--            </div>-->
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <textarea name="txtContent" class="form-control"
                              style="height: 120px"><?php echo $info_service->content ?></textarea>
                    <script type="text/javascript">CKEDITOR.replace('txtContent', {height: '300px'}); </script>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Gói DV<span
                            class="required">*</span></label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <select class="select2_group form-control" name="service_package_id">
                        <?php
                        foreach ($banner_packgage as $value) { ?>
                            <option value="<?php echo $value->id ?>" <?php if ($value->id == $info_service->service_package_id) echo 'selected' ?>><?php echo $value->name ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-top: 30px">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-1" style="width: 70px">
                    <a href="<?php echo admin_url('info_service') ?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
        </form>
    </div>
