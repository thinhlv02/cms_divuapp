        ...
        <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input disabled type="text" id="txtName" name="name" value="<?php echo $res->name ?>"
...
<!--                </div>-->
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                    <textarea disabled class="form-control" name="descriptions" rows="3" placeholder=""><?php echo $res->des ?></textarea>
                </div>
            </div>
            <div class="form-group">
