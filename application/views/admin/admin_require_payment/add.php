...
<div class="x_panel">
    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Tên Login<span
            ...
            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">SĐT <span
                        class="required">*</span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input id="password-field" type="text" class="form-control" name="phone" placeholder="nhập sđt" required>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Tên đầy đủ <span
                        class="required">*</span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input id="password-field" type="text" class="form-control" name="fullname" placeholder="nhập fullname" required>
            </div>

            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Địa chỉ <span
                        class="required">*</span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input id="password-field" type="text" class="form-control" name="address" placeholder="nhập address" required>
            </div>

            <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">email <span
                        class="required">*</span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input id="password-field" type="text" class="form-control" name="email" placeholder="nhập email" required>
            </div>
