...
//                            $total = $value->pay_cards + $value->bank + $value->ktv;
                        $total += $value->money;
                            ...
                            <tr id="<?php ?>" class="<?php if (isset($_GET['asset_id']) && $_GET['asset_id'] == $value->id) echo 'bg_thanhly'; ?>">
                                ...
                                <td class="text-nowrap"><?php echo date('d-m-Y', strtotime($value->time_topup)) ?></td>
<!--                                <td class="text-nowrap">--><?php //echo date('d-m-Y', strtotime($value->created_at)) ?><!--</td>-->
                                <td>
                                    <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/doanhthu_contract/edit/'.$value->id)?>"><i class="fa fa-pencil"></i> Sửa</a>
...
<script type="text/javascript">
    function confirmDel(id) {
        ...
        if (r == true) {
            window.location.href = "<?php echo admin_url('doanhthu_contract/del/')?>" + id;
        }
    }
</script>