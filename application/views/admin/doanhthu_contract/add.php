    ...
    <div class="x_content">
        ...
        <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">UserID KH<span class="required">*</span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input type="text" id="" name="user_id" required="required"
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input type="number" id="" name="money" value="0"
                           class="form-control col-md-7 col-xs-12" placeholder="tiền">
                </div>
