        ...
        Highcharts.chart('container', {
            ...
            xAxis: {
                ...
                categories: [
                    ...
                    //                    } else {
                    foreach ($dau as $value) {
                        echo '"' . date("d-m", strtotime($value->date)) . '"' . ',';
//                                echo '"' . $value . '"' . ',';
                    }
                    //                    }
                    //                    die();
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Giải thích DAU <small> chi tiết</small></h2>
            <ul class="nav navbar-right panel_toolbox">
        ...
        <div class="x_content">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $dau_define = array(
                      'người dùng login' => 'Là lượng người đăng ký hôm trước và đăng nhập lại vào ngày hiện tại',
                      'Đăng ký mới' => 'Là lượng người đăng ký mới',
                      'Dau' => 'Tổng của người dùng login và đăng ký mới',
                    );
                    $stt = 0;
                    foreach ($dau_define as $key_df => $value_df) { $stt++; ?>
                        <tr>
                            <th scope="row"><?php echo $stt; ?></th>
                            <td><?php echo $key_df ?></td>
                            <td><?php echo $value_df ?></td>
                        </tr>
                    <?php }
                    ?>
