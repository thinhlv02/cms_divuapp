...
<div class="page-title">
    <div class="title_left"><h3>Dịch vụ lắp đặt(<?php echo count($service_package) ?>)</h3></div>
...
<div class="x_panel">
    <div class="x_title">
        <!--        <h2>Danh sách bài đăng(--><?php //echo count($service_package) ?><!--)</h2>-->
    ...
    <div class="x_content">
        <table id="datatable-product" class="table table-striped table-bordered bulk_action">
            ...
            <tr>
                ...
                <th>Giá</th>
                <th>Lợi ích</th>
                <th>Số lần kh  chủ động đặt lịch</th>
                <th>Hành động</th>
            </tr>
            </thead>
            <tbody>
            <?php $i = 0; ?>
            <?php foreach ($service_package as $row) {
                $i++; ?>
                <tr>
                    <td><?php echo $i ?></td>
                    ...
                    <td><?php echo $row->number_maintenance ?></td>
                    <!--                    <td><img src="-->
                    <?php //echo base_url('public/images/news/'.$row->img)?><!--" style="max-width: 80px"> </td>-->
                    <td>
                        <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/service_package/edit/' . $row->id) ?>"><i class="fa fa-pencil"></i> Sửa</a>
