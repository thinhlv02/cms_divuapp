        ...
        <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12">
                    <input type="number" id="" name="number" required="required" value="1"
                           class="form-control col-md-7 col-xs-12" placeholder="SL" min="0">
                </div>

                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Đơn vị<span class="required">*</span></label>
                <div class="col-md-1 col-sm-1 col-xs-12">
                    <input type="text" id="" name="unit" required="required"
