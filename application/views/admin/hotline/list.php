...
<div class="page-title">
    <div class="title_left"><h3>Hotline(<?php echo count($res) ?>)</h3></div>
...
<!--        <h2>Danh sách bài đăng(--><?php //echo count($res) ?><!--)</h2>-->
        <div class="col-md-6 col-sm-6 col-xs-12 pull-left">
            <a href="<?php echo admin_url('hotline/add') ?>" class="btn btn-primary btn-sm">Thêm mới</a>
            <!--            <a href="-->
            <?php //echo admin_url('admin') ?><!--" class="btn btn-info btn-sm">Quay lại danh sách</a>-->
        </div>
...
<!--                    <td><img src="--><?php //echo base_url('public/images/hotline/'.$row->img)?><!--" style="max-width: 80px"> </td>-->
                    <td>
                        <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/hotline/edit/'.$row->id)?>"><i class="fa fa-pencil"></i> Sửa</a>
...
//            console.log('delll');
            window.location.href = '<?php echo base_url('admin/hotline/del/')?>' + id;
        }
    }
</script>