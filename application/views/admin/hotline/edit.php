...
<!--            </div>-->
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-2 col-xs-12" for="first-name">SĐT<span
                            class="required">*</span></label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <input type="text" id="" name="txtContent" value="<?php echo $res->content ?>"
                           required="required" class="form-control col-md-7 col-xs-12"
                           placeholder="">
                </div>
            </div>
            <div class="form-group" style="margin-top: 30px">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-1" style="width: 70px">
                    <a href="<?php echo admin_url('hotline') ?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
        </form>
    </div>
