...
<div class="page-title">
    ...
    <!--            <!--            <a href="-->
    <!--            --><?php ////echo admin_url('menu/add') ?><!--<!--" class="btn btn-primary btn-sm">Thêm mới</a>-->
    <!--            <a href="-->
    <?php //echo admin_url('menu') ?><!--" class="btn btn-info btn-sm">Quay lại danh sách</a>-->
    <!--        </div>-->
    <!--    </div>-->
</div>
<?php //  pre($unit); ?>
<div class="x_panel">
    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Tên menu<span
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <a href="<?php echo admin_url('menu') ?>" class="btn btn-success">Quay lại</a>
            </div>
        </div>
    </form>
</div>
