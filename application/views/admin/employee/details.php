...
<div class="page-title">
    <div class="title_left"><h3>Chi tiết</h3></div>
    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input disabled type="text" name="maso" value="<?php echo $employee->maso ?>" required
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input disabled type="text" id="txtName" name="txtName" value="<?php echo $employee->name ?>" required
                       placeholder="HỌ TÊN"
                       class="form-control col-md-7 col-xs-12">
            </div>
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
                <select disabled class="select2_group form-control" name="sex">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <input disabled type="text" id="txtTo3" name="birthday" required
            ...
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Nơi Sinh<span
                        class="required"></span></label>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input disabled type="text" id="" name="noisinh" value="<?php echo $employee->name ?>"
                       class="form-control col-md-7 col-xs-12">
            </div>
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input disabled type="text" id="" name="cmtnd" placeholder="Số cmtnd" value="<?php echo $identity[0] ?>"
                       class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Ngày cấp<span
                        class="required"></span></label>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input disabled type="text" id="txtTo4" name="ngaycap" value="<?php echo date('d-m-Y', $identity[1]) ?>"
            ...
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Nơi cấp<span
                        class="required"></span></label>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input disabled type="text" id="" name="captai" value="<?php echo $identity[2] ?>"
                       class="form-control col-md-7 col-xs-12">
            </div>
            ...
            <!--            <span style="float: left;margin-top: 7px">Số</span>-->
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input disabled type="text" id="" name="address" required placeholder="Hộ khẩu thường trú"
        ...
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Chỗ ở H.tại<span
                        class="required"></span></label>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input disabled type="text" placeholder="Chỗ ở hiện tại" value="<?php echo $employee->ohientai ?>"
            ...
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">SĐT cá nhân<span
                        class="required"></span></label>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input disabled type="text" id="" name="phone" value="<?php echo $employee->phone ?>"
                       class="form-control col-md-7 col-xs-12">
            </div>
            ...
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">EMail C.nhân<span
                        class="required"></span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input disabled type="text" name="email" placeholder="MAIL CÁ NHÂN"
            ...
            <div class="form-group">
                ...
                <!--            <span style="float: left;margin-top: 7px">Số</span>-->
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input disabled type="text" id="" name="hotline" placeholder=""
                           value="<?php echo $employee->hotline ?>"
                           class="form-control col-md-6 col-xs-11">
                </div>
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">EMail C.ty<span
                            class="required"></span></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <input disabled type="text" name="email_cty" placeholder="Mail công ty"
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">TK Skype<span
                            class="required"></span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input disabled type="text" name="skype" placeholder="Tài khoản skype" value="<?php echo $employee->skype ?>"
                           class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <!--            <span style="float: left;margin-top: 7px">Số</span>-->
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input disabled type="text" name="position" placeholder="chức vụ"
                ...
                <!--            <span style="float: left;margin-top: 7px">Số</span>-->
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <input disabled type="text" name="transaction_name" placeholder="Tên giao dịch"
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Phòng ban<span
                            class="required"></span></label>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <select disabled class="select2_group form-control" name="department">
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Nơi làm việc<span
                            class="required"></span></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <input disabled type="text" value="<?php echo $employee->noi_lamviec ?>" name="noi_lamviec"
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Ngày BDVL<span
                            class="required"></span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input disabled type="text" id="txtFrom" name="ngay_bd"
                           value="<?php echo date('d-m-Y', $employee->ngay_bd) ?>" required
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">HĐTV<span
                            class="required"></span></label>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input disabled type="text" name="hdtv" placeholder="HĐTV"
                           class="form-control col-md-7 col-xs-12">
                </div>
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">QĐCT<span
                            class="required"></span></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <input disabled type="text" id="txtTo" name="qdct" required
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">HĐLĐ<span
                            class="required"></span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input disabled type="text" id="txtTo2" name="hdld" required
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">QĐNV<span
                            class="required"></span></label>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input disabled type="text" name="qdnv" placeholder="QĐNV" value="<?php echo $employee->name ?>"
                           class="form-control col-md-7 col-xs-12">
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?php if (isset($employee->img)) { ?>
                        <td><img src="<?php echo base_url() ?>public/images/employee/<?php echo $employee->img ?>"
                                 alt="..."
            ...
            <div class="form-group">
                <div class="col-md-1 col-sm-1 col-xs-12 col-md-offset-1" style="">
                    <input type="submit" id="btnAddEvent" name="btnback" required="required" class="btn btn-success"
                           value="Quay lại danh sách">
                </div>
                <!--            <div class="col-md-3 col-sm-3 col-xs-12">-->
                <!--                <!--            <a href="-->
                <!--                -->
