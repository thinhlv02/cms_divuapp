...
<div class="page-title">
    <div class="title_left"><h3>Chi tiết gian hàng </h3></div>
        ...
        <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input disabled type="text" id="txtName" name="txtName" value="<?php echo $res->name ?>"
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-1 text-nowrap" for="first-name">Tên cửa hàng<span
                            class="required"></span></label>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <select disabled class="select2_group form-control" name="shop_id">
                        <?php
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <input disabled type="number" id="txtName" name="price" value="<?php echo $res->price ?>"
...
<!--                    <input type="file" class="form-control" name="img_product" id="img_product">-->
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Loại<span
                            class="required">*</span></label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <select disabled class="select2_group form-control" name="type">
                        <?php
                ...
                <div class="col-md-1 col-sm-1 col-xs-12">
                    <input disabled type="number" id="" name="number" required="required" value="<?php echo $res->number ?>"
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">Giảm giá<span
                            class="required">*</span></label>
                <div class="col-md-1 col-sm-1 col-xs-12">
                    <input disabled type="number" id="" name="sale" value="<?php echo $res->sale*100 ?>"
                           required="required" class="form-control col-md-7 col-xs-12"
...
<!--            </div>-->
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <textarea disabled name="txtContent" class="form-control"
...
<!--                </div>-->
                <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-1" style="width: 70px">
                    <a href="<?php echo admin_url('product_config') ?>" class="btn btn-primary">Quay lại</a>
                </div>
            </div>
        </form>
    </div>
