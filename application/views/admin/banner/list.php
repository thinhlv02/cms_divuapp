...
<div class="page-title">
    <div class="title_left"><h3>Ảnh banner(<?php echo count($res) ?>)</h3></div>
        ...
        <table id="datatable-banner" class="table table-striped table-bordered bulk_action">
            ...
            <?php foreach ($res as $row){ $i++; ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-xs" href="<?php echo base_url('admin/banner/edit/'.$row->id)?>"><i class="fa fa-pencil"></i> Edit</a>
