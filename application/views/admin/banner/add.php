    ...
    <div class="x_content">
        ...
        <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
            ...
            <div class="form-group">
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">route<span class="required">*</span></label>
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <input type="text" id="" name="route" required="required"
                ...
                <label class="control-label col-md-1 col-sm-1 col-xs-12" for="first-name">description<span class="required">*</span></label>
                <div class="col-md-3 col-sm-3 col-xs-12">
