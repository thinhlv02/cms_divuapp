    ...
    <form id="formAddProduct" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-12">
                <input type="number" name="time" class="form-control" placeholder="Default Input" min="0" value="5">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Giới hạn<span
                        class="required"></span></label>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input type="number" name="limit" class="form-control" placeholder="Default Input" min="0" value="5">
            </div>

            <label class="control-label col-md-1 col-sm-1 col-xs-12 text-nowrap" for="first-name">Tỷ lệ(%)<span
                        class="required"></span></label>
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input type="number" name="tyle" class="form-control" placeholder="Default Input" min="0" max="100" value="0">
            </div>
        </div>
