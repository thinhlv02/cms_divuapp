...
class MY_Model extends CI_Model
{
    ...
    {
        $this->svip_account = $this->load->database('default', TRUE);
//        $this->svip = $this->load->database('svip', TRUE);
//        $this->svip_logs = $this->load->database('svip_logs', TRUE);
    }
     ...
     */
    function create($dbName = 'svip_account', $data = array())
    {
        if ($this->$dbName->insert($this->table, $data)) {
            return TRUE;
        } else {
            return FALSE;
        }
     ...
     */
//    conga1411 comment
//    function query($dbName = 'svip_account', $sql)
//    {
//        $rows = $this->$dbName->query($sql);
//        return $rows->result();
//    }
//    End conga1411 comment
    ...
    function get_list($dbName = 'svip_account', $input = array())
    {
        //xu ly ca du lieu dau vao
        $this->get_list_set_input($dbName, $input);
        //thuc hien truy van du lieu
        $query = $this->$dbName->get($this->table);
        //echo $this->db->last_query();
        return $query->result();
    }

//    function get_list_where($dbName = 'svip_account', $input = array())
//    {
//
//    }
