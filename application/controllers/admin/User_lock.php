...
Class User_lock extends MY_Controller
{
    ...
    function index()
    {
        ...
        $input = array();
        $input['where']['is_active'] = 2;
        $input['order'] = array('id', 'desc');

        $list = $this->admin_model->get_list($input);
        $this->data['user_lock'] = $list;
//        pre($news2);
        $this->data['temp'] = 'admin/user_lock/list';
...
//                );
//                if ($this->user_lock_model->create($data)) {
...
//        $this->data['view'] = 'admin/news2/add';
    ...
    function edit()
    {
        ...
        $news2 = $this->admin_model->get_info($id);
        if (!$news2) {
            redirect(base_url('admin/news2'));
        }
...
//        $this->data['view'] = 'admin/news2/edit';
    ...
    {
//        pre($slug);
        $detail = $this->admin_model->get_info($id);
        $news2 = $this->admin_model->get_list(array('limit' => array(5, 0), 'order' => array('id', 'desc')));
