...
Class Technician_jobs extends MY_Controller
{
...
//        $list_emp = $this->asset_model->get_list();
    ...
    function index()
    {
        ...
        $search = 'all';
        $admin_id = 'all';
        $service_package_maintenance_status = 'all';
        if ($this->input->post('search')) {
            $search = 1;
//            pre('fuck');
            $service_package_maintenance_status = $this->input->post('service_package_maintenance_status');
...
//            pre($date1);
            ...
            $asset = $this->technician_jobs_model->get_info_mission($search, $date1, $date2, $admin_id, $service_package_maintenance_status);
////            pre($asset);
...
//        }
//        pre($asset);
        $this->data['temp'] = 'admin/technician_jobs/list';
