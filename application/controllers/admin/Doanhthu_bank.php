...
Class Doanhthu_bank extends MY_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('admin_model');
        $this->load->model('doanhthu_bank_model');
...
//            pre($date1);
            $asset = $this->doanhthu_bank_model->get_doanhthu_bank($search, $date1, $date2);
////            pre($asset);
        } //        $asset = $this->asset_model->get_list();
        else {
            $asset = $this->doanhthu_bank_model->get_doanhthu_bank($search, $date1, $date2, $admin_id);
        }
//        pre($arr_asset);
...
//        pre($asset);
        ...
        $this->data['temp'] = 'admin/doanhthu_bank/list';
