...
//            mycontroller
            ...
            /*End hlv ,dv excel*/
            $this->session->unset_userdata('asset_box');
            $this->session->unset_userdata('repair_box');
            $this->session->unset_userdata('liquidated_box');
            $this->session->unset_userdata('Asset');
            $this->session->unset_userdata('s_arr');
        }
